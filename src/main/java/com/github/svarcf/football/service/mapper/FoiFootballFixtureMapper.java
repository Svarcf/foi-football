 ...
 */
@Mapper(componentModel = "spring", uses = {FoiFootballTournamentMapper.class, FoiFootballTeamMapper.class})
public interface FoiFootballFixtureMapper extends EntityMapper<FoiFootballFixtureDTO, FoiFootballFixture> {
    ...
    FoiFootballFixtureDTO toDto(FoiFootballFixture foiFootballFixture);
    ...
    FoiFootballFixture toEntity(FoiFootballFixtureDTO foiFootballFixtureDTO);
